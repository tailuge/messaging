...
> The minimal Arena MVP is specified separately in [`arena-spec.md`](./arena-spec.md). This document's Arena section describes the broader future Arena plan; use the separate spec as the implementation source of truth for the initial phase.
