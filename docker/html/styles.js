...
export const LOBBY_APP_STYLES = css`
    :host { display: flex; flex-direction: column; min-height: 100%; font-family: sans-serif; font-size: 0.85rem; box-sizing: border-box; padding: 0.5rem; gap: 0.2rem; background: #f5f5f5; overflow-y: auto; scrollbar-width: none; }
