...
`];var ge=class extends EventTarget{clientId=localStorage.getItem("clientId")||"";userName=localStorage.getItem("userName")||"Anonymous";set(e,t){this.clientId=e,this.userName=t,localStorage.setItem("clientId",e),localStorage.setItem("userName",t),this.dispatchEvent(new Event("change"))}},A=new ge,_=class extends g{connectedCallback(){super.connectedCallback(),this._storeListener=()=>this.requestUpdate(),A.addEventListener("change",this._storeListener)}disconnectedCallback(){super.disconnectedCallback(),A.removeEventListener("change",this._storeListener)}};var Et=[{label:"Nine Ball",img:"assets/nineball.png",ruletype:"nineball"},{label:"Snooker 6r",img:"assets/snooker.png",ruletype:"snooker",options:{reds:"6"}},{label:"Snooker",img:"assets/snooker.png",ruletype:"snooker",options:{reds:"15"}},{label:"3-Cushion",img:"assets/threecushion.png",ruletype:"threecushion",options:{raceTo:"3"}},{label:"3-Cushion 11",img:"assets/threecushion.png",ruletype:"threecushion",options:{raceTo:"11"}},{label:"3-Cushion 21",img:"assets/threecushion.png",ruletype:"threecushion",options:{raceTo:"21"}},{label:"Trickshot",img:"assets/practice.png",url:"https://billiards.tailuge.workers.dev/practice"},{label:"Research",img:"assets/research.png",url:"https://billiards.tailuge.workers.dev/diagrams/three"},{label:"Eight Ball",img:"assets/eightball.png",ruletype:"eightball"}],St=(r,e,t)=>{if(r.url)return`${r.url}?clientId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}`;let s=`https://billiards.tailuge.workers.dev/?ruletype=${r.ruletype}&clientId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}`;return r.options&&Object.entries(r.options).forEach(([i,n])=>s+=`&${i}=${encodeURIComponent(n)}`),s},be=class extends _{static styles=[Je,W];render(){let{clientId:e,userName:t}=A;return l`<div class="grid">${Et.map(s=>l`
    ...
    `;render(){return l`
        ...
        `}};customElements.define("replay-button",ye);var ve=class extends g{static styles=Ke;connectedCallback(){super.connectedCallback(),fetch(`${j}/api/summary`,{mode:"cors"}).then(e=>e.json()).then(e=>{this._data=e,this.requestUpdate()}).catch(()=>{this._err=!0,this.requestUpdate()})}render(){if(this._err)return l`<span class="loading">Could not load scores.</span>`;if(!this._data)return l`<span class="loading">Loading…</span>`;let{hiscores:e,topPlayers:t,recentMatches:s}=this._data,i=Object.keys(e);return l`
            ...
            </div>`}},xe=class r extends g{static properties={userId:{type:String},userName:{type:String}};static styles=[I,F,W];static RULES=[{id:"eightball",label:"Eight Ball",img:"assets/eightball.png"},{id:"nineball",label:"Nine Ball",img:"assets/nineball.png"},{id:"threecushion",label:"Three Cushion",img:"assets/threecushion.png"},{id:"threecushion",label:"Three Cushion (11)",img:"assets/threecushion.png",options:{raceTo:"11"}},{id:"threecushion",label:"Three Cushion (21)",img:"assets/threecushion.png",options:{raceTo:"21"}},{id:"snooker",label:"Snooker",img:"assets/snooker.png"},{id:"snooker",label:"Snooker (6 reds)",img:"assets/snooker.png",options:{reds:"6"}}];render(){return this.userId?l`
            ...
            </div>`}};customElements.define("user-badge",Se);var we=class extends _{static properties={_open:{state:!0},_notifEnabled:{state:!0}};static styles=[I,F,u`
